...
export default function AreasSection() {
  return (
    <section className="pt-8 pb-16 md:pt-12 md:pb-28 bg-surface" id="areas">
      <div className="section-shell px-4 md:px-6 space-y-8 md:space-y-10">
        <div className="space-y-3 max-w-2xl">
          <span className="section-kicker font-label text-[0.65rem] uppercase tracking-[0.3em] font-semibold">Áreas de práctica</span>
          <h2 className="section-heading-serif">
            Asistencia legal enfocada<br />en tus derechos
          </h2>
          <p className="text-on-surface-variant text-sm leading-relaxed max-w-lg">Atención profesional en conflictos de salud, trabajo, sucesiones y reclamos indemnizatorios, con una estrategia clara para cada caso.</p>
        </div>
